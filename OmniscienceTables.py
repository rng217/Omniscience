...
'ch':66,'chen':66,'holy knight':66,
'clinkz':56,
'clock':51,'clockwerk':51,
'cm':5,'crystal maiden':5,'maiden':5,
'ds':55,'seer':55,'dark seer':55,
'daz':50,'dazzle':50,'dazzul':50,
'dp':43,'death prophet':43,'krob':43,'krobelus':43,
'dis':87,'disruptor':87,
...
'np':53,'nature\'s prophet':53,'profit':53,'furi':53,'furion':53,
...
'pl':12,'lancer':12,'phantom lancer':12,'cancer':12,
'pudge':14,'butcher':14,
'puck':13,
'pugna':45,
...
'spectre':67,
'slark':93,
'ta':46,'templar':46,'templar assassin':46,'lanaya':46,
